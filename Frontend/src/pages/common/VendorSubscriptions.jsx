...
const SEED_SUBSCRIPTIONS = [
  ...
  },
  {
    ...
    planTier: 'Starter',
    monthlyFee: 999,
    billingCycle: 'Monthly (5th to 5th)',
    lastPaymentDate: '2026-09-05',
    lastPaymentMode: 'UPI (PhonePe)',
    lastTransactionId: 'UPI-8839102451',
    nextDueDate: '2026-10-05',
    status: 'Active & Paid',
    daysRemaining: 24,
    invoiceNumber: 'INV-SUB-2026-09-029'
  },
  {
    id: 'SUB-VND-04',
    vendorId: 'VND-636002-01',
    vendorName: 'Shevapet Textures & Home Decors',
    owner: 'Ramesh Sundaram',
    phone: '+91 94431 10003',
    category: 'Textile & Home',
    state: 'Tamil Nadu',
    district: 'Salem',
    division: 'Salem North',
    pincode: '636002',
    ...
    lastTransactionId: 'NET-4491029411',
    nextDueDate: '2026-10-01',
    status: 'Active & Paid',
    daysRemaining: 20,
    invoiceNumber: 'INV-SUB-2026-09-005'
  },
  {
    id: 'SUB-VND-05',
    vendorId: 'VND-636004-01',
    vendorName: 'Gugai Spares & Hardware Depot',
    owner: 'M. Senthil Kumar',
    ...
    planTier: 'Growth',
    monthlyFee: 1999,
    billingCycle: 'Monthly (10th to 10th)',
    lastPaymentDate: '2026-08-10',
    lastPaymentMode: 'UPI (Paytm)',
    lastTransactionId: 'UPI-7781029482',
    nextDueDate: '2026-09-10',
    status: 'Due for Renewal',
    daysRemaining: 1,
    invoiceNumber: 'INV-SUB-2026-08-033'
  },
  {
    id: 'SUB-VND-06',
    vendorId: 'VND-641001-01',
    vendorName: 'Kovai Power Tools & Spares',
    owner: 'S. Shanmugam',
    phone: '+91 94435 55001',
    ...
    billingCycle: 'Monthly (1st to 30th)',
    lastPaymentDate: '2026-09-01',
    lastPaymentMode: 'Corporate Card',
    lastTransactionId: 'CARD-9910248102',
    nextDueDate: '2026-10-01',
    status: 'Active & Paid',
    daysRemaining: 20,
    invoiceNumber: 'INV-SUB-2026-09-041'
  },
  {
    id: 'SUB-VND-07',
    vendorId: 'VND-600001-01',
    vendorName: 'Madras Natural Foods',
    owner: 'C. Venkatesan',
    phone: '+91 94436 66001',
    ...
    billingCycle: 'Monthly (1st to 30th)',
    lastPaymentDate: '2026-09-01',
    lastPaymentMode: 'UPI (GPay)',
    lastTransactionId: 'UPI-1192847192',
    nextDueDate: '2026-10-01',
    status: 'Active & Paid',
    daysRemaining: 20,
    invoiceNumber: 'INV-SUB-2026-09-052'
  }
];
