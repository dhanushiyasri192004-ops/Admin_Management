...
export function DistrictDeliveryPartners() {
  ...
  const [partners, setPartners] = useState([
    ...
    },
    {
      ...
      vehicleType: 'Motorcycle',
      registrationNumber: 'TN-30-EF-9012',
      district: districtName,
      ...
      activeDeliveries: 1,
      recentDeliveries: [
        { orderId: 'ORD-2026-904', customer: 'Divya Prakash', destination: 'Hasthampatti, Salem', time: '11:15 AM Today', status: 'In Transit' }
      ]
    },
    {
      id: 'DEL-SLM-04',
      ...
      registrationNumber: 'TN-30-GH-3456',
      district: districtName,
      division: 'Salem South',
      pincode: '636004',
      rating: 4.7,
      ...
      activeDeliveries: 2,
      recentDeliveries: [
        { orderId: 'ORD-2026-912', customer: 'Lakshmi Narayanan', destination: 'Ammapet, Salem', time: '10:00 AM Today', status: 'In Transit' }
      ]
    }
  ]);
