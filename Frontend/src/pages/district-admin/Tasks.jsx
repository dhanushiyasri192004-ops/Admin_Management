...
const INITIAL_DISTRICT_TASKS = [
  ...
  {
    id: 'TSK-1004',
    title: 'Audit Shevapet Bazaar POS Settlement & Payout Batches',
    category: 'Payout Reconciliation',
    priority: 'High',
    assignedTo: 'Salem District Operations',
    district: 'Salem',
    division: 'Salem North',
    dueDate: '2026-09-14',
    status: 'Pending'
  ...
  {
    id: 'TSK-1005',
    title: 'Verify Divisional Field Executive Roster & Quota Attendance',
    category: 'Compliance',
    priority: 'Normal',
    assignedTo: 'Salem South Divisional Admin',
    district: 'Salem',
  ...
  {
    id: 'TSK-1006',
    title: 'Reconcile Merchant GST Invoices for Active District Vendors',
    category: 'Compliance',
    priority: 'High',
    assignedTo: 'District Finance Coordinator',
    district: 'Salem',
    division: 'Salem North',
    dueDate: '2026-09-15',
    status: 'Pending'
  ...
  {
    id: 'TSK-1007',
    title: 'Resolve Pincode 636001 Customer Privilege Card Delivery Escalations',
    category: 'Customer Loyalty',
    priority: 'Urgent',
    assignedTo: 'District Support Desk',
    district: 'Salem',
    division: 'Salem North',
    dueDate: '2026-09-09',
    status: 'In Progress'
  ...
  {
    id: 'TSK-1008',
    title: 'Approve Pincode 636003 Field Technician Equipment Requisitions',
    category: 'Operations',
    priority: 'Normal',
    assignedTo: 'Salem South Operations Lead',
    district: 'Salem',
    division: 'Salem South',
    dueDate: '2026-09-07',
    status: 'Completed'
