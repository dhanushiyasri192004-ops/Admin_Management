...
export function DivisionalAgents() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-xl font-bold text-slate-900 dark:text-white">Division Field Agents</h2>
        <p className="text-xs text-slate-500 dark:text-slate-400">
          Field customer onboarding agents operating within {user?.division || 'Salem North'} Division.
        </p>
      </div>
