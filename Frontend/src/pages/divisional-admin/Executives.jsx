      ...
      render: (row) => (
        <div className="text-xs">
          <div className="font-semibold text-slate-900 dark:text-white flex items-center gap-1">
            ...
            <span className="text-slate-600 dark:text-slate-300 font-medium whitespace-nowrap">{row.division || user?.division || 'Salem North'}</span>
          </div>
    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-xs text-slate-500 dark:text-slate-400">
          Vendor-assigned operations personnel managing stay and travel bookings in {user?.division || 'Salem North'} Division.
        </p>
      </div>
