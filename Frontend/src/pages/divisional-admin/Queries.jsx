...
const INITIAL_DIVISIONAL_QUERIES = [
  {
    id: 'QR-9101',
    subject: 'Pincode 636001 Commercial Zone Hub Route Re-alignment',
    category: 'Logistics Route',
    priority: 'High',
    raisedBy: 'Thirunavukkarasu R',
    userRole: 'Divisional Field Agent',
    district: 'Salem',
  ...
  {
    id: 'QR-9102',
    subject: 'Merchant POS Hardware Offline Gateway Error at Shevapet',
  ...
  {
    id: 'QR-9103',
    subject: 'Membership Privilege Card Discount Application on Dairy Items',
    category: 'Customer Privilege',
    priority: 'Normal',
    raisedBy: 'Priya Narayanan',
    userRole: 'Pincode Admin',
    district: 'Salem',
    division: 'Salem North',
    pincode: '636001',
    slaDate: '2026-09-08',
  ...
  {
    id: 'QR-9104',
    subject: 'Delivery Fleet Battery Swap Station Allocation Query',
    category: 'Fleet Operations',
    priority: 'Medium',
    raisedBy: 'Muruganandam V',
  ...
  {
    id: 'QR-9105',
    subject: 'Agent Commission Weekly Settlement Dispute for PIN 636002',
    category: 'Agent Commission',
    priority: 'High',
    raisedBy: 'Naveen Kumar M',
  ...
  {
    id: 'QR-9106',
    subject: 'App Technician Availability Sync Error in Morning Slot',
    category: 'App Support',
    priority: 'Normal',
    raisedBy: 'Salem North Ops Desk',
