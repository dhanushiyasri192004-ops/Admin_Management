...
const INITIAL_DIVISIONAL_TASKS = [
  {
    id: 'TSK-2001',
    title: 'Review Pincode 636001 Field Merchant KYC Backlog',
    category: 'KYC Clearance',
    priority: 'Urgent',
    assignedTo: 'Salem North Divisional Admin',
    district: 'Salem',
  ...
  {
    id: 'TSK-2002',
    title: 'Inspect Pincode 636002 Hub Readiness & Logistics Quota',
    category: 'Operations',
    priority: 'Medium',
    assignedTo: 'Salem North Field Operations',
    district: 'Salem',
    division: 'Salem North',
    pincode: '636002',
    dueDate: '2026-09-15',
  ...
  {
    id: 'TSK-2003',
    title: 'Audit Shevapet Bazaar POS Settlement Batches',
    category: 'Payout Reconciliation',
    priority: 'High',
    assignedTo: 'Divisional Accounts Desk',
    district: 'Salem',
    division: 'Salem North',
    pincode: '636002',
    dueDate: '2026-09-14',
  ...
  {
    id: 'TSK-2004',
    title: 'Verify Local Pincode Technician Attendance & Service Records',
    category: 'Compliance',
    priority: 'Normal',
    assignedTo: 'Salem North Divisional Admin',
    district: 'Salem',
  ...
  {
    id: 'TSK-2005',
    title: 'Quarterly Service Coverage Expansion in Shevapet Sector',
    category: 'Expansion',
    priority: 'High',
    assignedTo: 'Pincode Operations Team',
    district: 'Salem',
    division: 'Salem North',
    pincode: '636002',
    dueDate: '2026-09-18',
  ...
  {
    id: 'TSK-2006',
    title: 'Coordinate Delivery Fleet Fuel Allowance & Battery Swap Audit',
    category: 'Logistics',
    priority: 'Medium',
