...
export function PincodeVendorDetails() {
  ...
  const vendors = [
    {
      id: 'VND-636001-01',
      name: 'Sri Murugan Provisions',
      category: 'Grocery & FMCG Retail',
      owner: 'Muruganandam S',
      phone: '+91 94432 11001',
      email: 'murugan_stores@gmail.com',
      address: '14 Bazaar Street, Fort Main, Salem - 636001',
      rating: 4.8,
      ordersCompleted: 145,
      commissionRate: '8%',
    ...
    {
      id: 'VND-636001-02',
      name: 'Salem Supermart',
      category: 'Supermarket & Essentials',
      owner: 'K. Rajasekaran',
      phone: '+91 94432 22002',
      email: 'salem_supermart@gmail.com',
      address: '88 Car Street, Near Temple, Salem - 636001',
      rating: 4.6,
      ordersCompleted: 98,
      commissionRate: '10%',
      status: 'Verified & Active'
