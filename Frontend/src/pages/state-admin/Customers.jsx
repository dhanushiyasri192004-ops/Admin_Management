    ...
    <div className="space-y-6">
      <div>
        ...
        <p className={`text-xs ${isDark ? 'text-slate-400' : 'text-slate-500'}`}>
          All registered customers within assigned state jurisdiction, including card and non-card members.
        </p>
      </div>

      {/* Metric Cards - matched to Managers 2nd image size and alignment */}
