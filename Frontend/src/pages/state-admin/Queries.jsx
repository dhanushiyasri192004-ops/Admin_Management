...
const INITIAL_QUERIES = [
  {
    id: 'QR-8101',
    subject: 'Vendor Settlement Discrepancy for Salem North Cluster',
    category: 'Payment & Payouts',
    priority: 'Urgent',
    raisedBy: 'M. Senthilkumar',
    userRole: 'District Admin (Salem)',
    district: 'Salem',
  ...
  {
    id: 'QR-8102',
    subject: 'Boundary Overlap & Pincode 636003 Remapping Request',
    category: 'Territory Setup',
    priority: 'High',
    raisedBy: 'Karthik Raja',
    userRole: 'Divisional Admin (Salem South)',
    district: 'Salem',
  ...
  {
    id: 'QR-8103',
    subject: 'Merchant GST Certificate Re-verification Escalation',
    category: 'KYC & Compliance',
    priority: 'High',
    raisedBy: 'Ananya Iyer',
    userRole: 'Compliance Desk',
    district: 'Coimbatore',
  ...
  {
    id: 'QR-8104',
    subject: 'Agent Referral Payout Wallet Deduction Query',
    category: 'Agent Commission',
    priority: 'Medium',
    raisedBy: 'Thirunavukkarasu R',
    userRole: 'Agent Partner',
    district: 'Salem',
    division: 'Salem North',
    slaDate: '2026-09-10',
    status: 'Pending'
  ...
  {
    id: 'QR-8105',
    subject: 'Membership Privilege Card Offline POS Reader Error',
    category: 'Hardware & POS',
    priority: 'Normal',
    raisedBy: 'Viji Enterprises',
    userRole: 'Vendor Merchant',
    district: 'Chennai',
  ...
  {
    id: 'QR-8106',
    subject: 'Delivery Partner Territory Transit Delay Investigation',
    category: 'Logistics',
    priority: 'Medium',
    raisedBy: 'Venkatesh Babu',
    userRole: 'Delivery Fleet Lead',
    district: 'Madurai',
    division: 'Madurai South',
    slaDate: '2026-09-11',
    status: 'Pending'
  },
  {
    id: 'QR-8107',
    subject: 'Customer Card Upgrade Status Mismatch Inquiry',
    category: 'Customer Loyalty',
    priority: 'Normal',
    raisedBy: 'State Support Desk',
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-1">
              <span className="font-mono text-[11px] font-semibold text-blue-600 dark:text-blue-400">{row.id}</span>
              <span className="text-slate-300 dark:text-slate-600">•</span>
              <span className="inline-flex items-center gap-1 text-[11px] text-slate-500 dark:text-slate-400 font-medium">
                <Tag className="w-3 h-3 text-slate-400" /> {row.category}
              </span>
            </div>
          </div>
        </div>
    ...
    },
    {
      ...
      render: (row) => (
        <div className="flex items-center gap-1.5 text-xs text-slate-600 dark:text-slate-300">
          ...
          <span className="font-mono">{row.slaDate}</span>
        </div>
      )
    },
    {
