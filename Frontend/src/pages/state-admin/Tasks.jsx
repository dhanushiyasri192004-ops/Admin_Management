...
const INITIAL_TASKS = [
  {
    id: 'TSK-1001',
    title: 'Review Salem North Division Merchant KYC Backlog',
    category: 'KYC Clearance',
    priority: 'Urgent',
    assignedTo: 'Salem District Admin',
    district: 'Salem',
  ...
  {
    id: 'TSK-1002',
    title: 'Audit Coimbatore Merchant Settlement Payout Batches',
    category: 'Payout Reconciliation',
    priority: 'High',
    assignedTo: 'Coimbatore District Admin',
    district: 'Coimbatore',
  ...
  {
    id: 'TSK-1003',
    title: 'Inspect Pincode 636004 Hub Readiness & Technician Quota',
    category: 'Operations',
    priority: 'Medium',
    assignedTo: 'Salem South Divisional Admin',
    district: 'Salem',
  ...
  {
    id: 'TSK-1004',
    title: 'Verify Membership Privilege Card Dispatch Log',
    category: 'Customer Loyalty',
    priority: 'Normal',
    assignedTo: 'State Membership Desk',
  ...
  {
    id: 'TSK-1005',
    title: 'Reconcile Q3 GST & TDS Invoices for All Active Vendors',
    category: 'Compliance',
    priority: 'High',
    assignedTo: 'Finance & Compliance Team',
    district: 'All Districts',
  ...
  {
    id: 'TSK-1006',
    title: 'Field Agent Onboarding Verification - Tirupur Sector',
    category: 'Agent Management',
    priority: 'Medium',
    assignedTo: 'Field Operations Executive',
    district: 'Coimbatore',
    division: 'Pollachi South',
    dueDate: '2026-09-14',
    status: 'In Progress'
  },
  {
    id: 'TSK-1007',
    title: 'Server Data Synchronization & Backup Audit',
    category: 'System Health',
    priority: 'Normal',
    assignedTo: 'Systems Engineering Team',
    district: 'Chennai Regional HQ',
    division: 'Statewide',
    dueDate: '2026-09-05',
    status: 'Completed'
  }
